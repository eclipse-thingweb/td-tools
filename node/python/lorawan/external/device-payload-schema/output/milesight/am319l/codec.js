// TS013 Payload Codec — milesight_am319l
// Schema version: 1
// Generated from: am319l.yaml
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      if ("[" + channel_id + ", " + channel_type + "]" === "[255, 1]") {
        ...
        var buzzer_status = readU(buf, pos, 1, endian);
        pos += 1;
        vars.buzzer_status = buzzer_status;
        d.buzzer_status = buzzer_status;
      } else {
        break;
      }
    }
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.buzzer_status !== undefined) {
      writeU(buf, pos, 1, 14, endian);
      pos += 1;
      writeU(buf, pos, 1, 1, endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.buzzer_status !== undefined ? d.buzzer_status : 0)), endian);
      pos += 1;
    }
