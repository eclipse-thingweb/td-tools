// TS013 Payload Codec — milesight_em500_lgt
// Schema version: 1
// Generated from: em500-lgt.yaml
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      if ("[" + channel_id + ", " + channel_type + "]" === "[1, 117]") {
        ...
        d.battery = battery;
      } else if ("[" + channel_id + ", " + channel_type + "]" === "[3, 148]") {
        var light = readU(buf, pos, 4, endian);
        pos += 4;
        vars.light = light;
        d.light = light;
      } else {
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.light !== undefined) {
      ...
      pos += 1;
      writeU(buf, pos, 4, Math.round((d.light !== undefined ? d.light : 0)), endian);
      pos += 4;
    }
