// TS013 Payload Codec — milesight_vs370
// Schema version: 1
// Generated from: vs370.yaml
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      if ("[" + channel_id + ", " + channel_type + "]" === "[255, 1]") {
        ...
        var illuminance = readU(buf, pos, 1, endian);
        pos += 1;
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.illuminance !== undefined) {
      writeU(buf, pos, 1, 4, endian);
      pos += 1;
      writeU(buf, pos, 1, 0, endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.illuminance !== undefined ? d.illuminance : 0)), endian);
      pos += 1;
    }
