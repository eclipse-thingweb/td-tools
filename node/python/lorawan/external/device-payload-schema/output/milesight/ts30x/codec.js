// TS013 Payload Codec — milesight_ts30x
// Schema version: 1
// Generated from: ts30x.yaml
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      if ("[" + channel_id + ", " + channel_type + "]" === "[255, 1]") {
        ...
        var temperature_chn1 = readS(buf, pos, 2, endian);
        pos += 2;
        vars.temperature_chn1 = temperature_chn1;
        d.temperature_chn1 = (temperature_chn1 / 10);
      } else if ("[" + channel_id + ", " + channel_type + "]" === "[3, 0]") {
        var magnet_chn1 = readU(buf, pos, 1, endian);
        pos += 1;
        vars.magnet_chn1 = magnet_chn1;
        d.magnet_chn1 = magnet_chn1;
      } else if ("[" + channel_id + ", " + channel_type + "]" === "[4, 103]") {
        var temperature_chn2 = readS(buf, pos, 2, endian);
        pos += 2;
        vars.temperature_chn2 = temperature_chn2;
        d.temperature_chn2 = (temperature_chn2 / 10);
      } else if ("[" + channel_id + ", " + channel_type + "]" === "[4, 0]") {
        var magnet_chn2 = readU(buf, pos, 1, endian);
        pos += 1;
        vars.magnet_chn2 = magnet_chn2;
        d.magnet_chn2 = magnet_chn2;
      } else if ("[" + channel_id + ", " + channel_type + "]" === "[131, 103]") {
        var temperature_chn1 = readS(buf, pos, 2, endian);
        pos += 2;
        vars.temperature_chn1 = temperature_chn1;
        d.temperature_chn1 = (temperature_chn1 / 10);
        var temperature_chn1_alarm = readU(buf, pos, 1, endian);
        pos += 1;
        vars.temperature_chn1_alarm = temperature_chn1_alarm;
        d.temperature_chn1_alarm = temperature_chn1_alarm;
      } else if ("[" + channel_id + ", " + channel_type + "]" === "[147, 215]") {
        var temperature_chn1 = readS(buf, pos, 2, endian);
        pos += 2;
        vars.temperature_chn1 = temperature_chn1;
        d.temperature_chn1 = (temperature_chn1 / 10);
        var temperature_chn1_mutation = readS(buf, pos, 2, endian);
        pos += 2;
        vars.temperature_chn1_mutation = temperature_chn1_mutation;
        d.temperature_chn1_mutation = (temperature_chn1_mutation / 100);
        var temperature_chn1_alarm = readU(buf, pos, 1, endian);
        pos += 1;
        vars.temperature_chn1_alarm = temperature_chn1_alarm;
        d.temperature_chn1_alarm = temperature_chn1_alarm;
      } else if ("[" + channel_id + ", " + channel_type + "]" === "[132, 103]") {
        var temperature_chn2 = readS(buf, pos, 2, endian);
        pos += 2;
        vars.temperature_chn2 = temperature_chn2;
        d.temperature_chn2 = (temperature_chn2 / 10);
        var temperature_chn2_alarm = readU(buf, pos, 1, endian);
        pos += 1;
        vars.temperature_chn2_alarm = temperature_chn2_alarm;
        d.temperature_chn2_alarm = temperature_chn2_alarm;
      } else if ("[" + channel_id + ", " + channel_type + "]" === "[148, 215]") {
        var temperature_chn2 = readS(buf, pos, 2, endian);
        pos += 2;
        vars.temperature_chn2 = temperature_chn2;
        d.temperature_chn2 = (temperature_chn2 / 10);
        var temperature_chn2_mutation = readS(buf, pos, 2, endian);
        pos += 2;
        vars.temperature_chn2_mutation = temperature_chn2_mutation;
        d.temperature_chn2_mutation = (temperature_chn2_mutation / 100);
        var temperature_chn2_alarm = readU(buf, pos, 1, endian);
        pos += 1;
        vars.temperature_chn2_alarm = temperature_chn2_alarm;
        d.temperature_chn2_alarm = temperature_chn2_alarm;
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.temperature_chn1 !== undefined) {
      writeU(buf, pos, 1, 3, endian);
      pos += 1;
      writeU(buf, pos, 1, 103, endian);
      pos += 1;
      writeS(buf, pos, 2, Math.round(((d.temperature_chn1 !== undefined ? d.temperature_chn1 : 0) * 10)), endian);
      pos += 2;
    }
    if (d.magnet_chn1 !== undefined) {
      writeU(buf, pos, 1, 3, endian);
      pos += 1;
      writeU(buf, pos, 1, 0, endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.magnet_chn1 !== undefined ? d.magnet_chn1 : 0)), endian);
      pos += 1;
    }
    if (d.temperature_chn2 !== undefined) {
      writeU(buf, pos, 1, 4, endian);
      pos += 1;
      writeU(buf, pos, 1, 103, endian);
      pos += 1;
      writeS(buf, pos, 2, Math.round(((d.temperature_chn2 !== undefined ? d.temperature_chn2 : 0) * 10)), endian);
      pos += 2;
    }
    if (d.magnet_chn2 !== undefined) {
      writeU(buf, pos, 1, 4, endian);
      pos += 1;
      writeU(buf, pos, 1, 0, endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.magnet_chn2 !== undefined ? d.magnet_chn2 : 0)), endian);
      pos += 1;
    }
    if (d.temperature_chn1 !== undefined || d.temperature_chn1_alarm !== undefined) {
      ...
      writeS(buf, pos, 2, Math.round(((d.temperature_chn1 !== undefined ? d.temperature_chn1 : 0) * 10)), endian);
      pos += 2;
      writeU(buf, pos, 1, Math.round((d.temperature_chn1_alarm !== undefined ? d.temperature_chn1_alarm : 0)), endian);
      pos += 1;
    }
    if (d.temperature_chn1 !== undefined || d.temperature_chn1_mutation !== undefined || d.temperature_chn1_alarm !== undefined) {
      writeU(buf, pos, 1, 147, endian);
      pos += 1;
      writeU(buf, pos, 1, 215, endian);
      pos += 1;
      writeS(buf, pos, 2, Math.round(((d.temperature_chn1 !== undefined ? d.temperature_chn1 : 0) * 10)), endian);
      pos += 2;
      writeS(buf, pos, 2, Math.round(((d.temperature_chn1_mutation !== undefined ? d.temperature_chn1_mutation : 0) * 100)), endian);
      pos += 2;
      writeU(buf, pos, 1, Math.round((d.temperature_chn1_alarm !== undefined ? d.temperature_chn1_alarm : 0)), endian);
      pos += 1;
    }
    if (d.temperature_chn2 !== undefined || d.temperature_chn2_alarm !== undefined) {
      ...
      writeS(buf, pos, 2, Math.round(((d.temperature_chn2 !== undefined ? d.temperature_chn2 : 0) * 10)), endian);
      pos += 2;
      writeU(buf, pos, 1, Math.round((d.temperature_chn2_alarm !== undefined ? d.temperature_chn2_alarm : 0)), endian);
      pos += 1;
    }
    if (d.temperature_chn2 !== undefined || d.temperature_chn2_mutation !== undefined || d.temperature_chn2_alarm !== undefined) {
      writeU(buf, pos, 1, 148, endian);
      pos += 1;
      writeU(buf, pos, 1, 215, endian);
      pos += 1;
      writeS(buf, pos, 2, Math.round(((d.temperature_chn2 !== undefined ? d.temperature_chn2 : 0) * 10)), endian);
      pos += 2;
      writeS(buf, pos, 2, Math.round(((d.temperature_chn2_mutation !== undefined ? d.temperature_chn2_mutation : 0) * 100)), endian);
      pos += 2;
      writeU(buf, pos, 1, Math.round((d.temperature_chn2_alarm !== undefined ? d.temperature_chn2_alarm : 0)), endian);
      pos += 1;
    }
