// TS013 Payload Codec — milesight_em300_zld
// Schema version: 1
// Generated from: em300-zld.yaml
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      if ("[" + channel_id + ", " + channel_type + "]" === "[1, 117]") {
        ...
        var water = readU(buf, pos, 1, endian);
        pos += 1;
        vars.water = water;
        d.water = water;
      } else {
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.water !== undefined) {
      ...
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.water !== undefined ? d.water : 0)), endian);
      pos += 1;
    }
