// TS013 Payload Codec — milesight_ws101
// Schema version: 1
// Generated from: ws101.yaml
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      if ("[" + channel_id + ", " + channel_type + "]" === "[1, 117]") {
        ...
        d.battery = battery;
      } else if ("[" + channel_id + ", " + channel_type + "]" === "[255, 46]") {
        var button = readU(buf, pos, 1, endian);
        pos += 1;
        vars.button = button;
        d.button = button;
      } else {
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.button !== undefined) {
      ...
      pos += 1;
      writeU(buf, pos, 1, 46, endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.button !== undefined ? d.button : 0)), endian);
      pos += 1;
    }
