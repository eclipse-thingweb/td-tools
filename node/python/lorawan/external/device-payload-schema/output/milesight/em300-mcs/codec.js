// TS013 Payload Codec — milesight_em300_mcs
// Schema version: 1
// Generated from: em300-mcs.yaml
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      if ("[" + channel_id + ", " + channel_type + "]" === "[255, 1]") {
        ...
        var magnet_status = readU(buf, pos, 1, endian);
        pos += 1;
        vars.magnet_status = magnet_status;
        d.magnet_status = magnet_status;
      } else {
        break;
      }
    }
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.magnet_status !== undefined) {
      writeU(buf, pos, 1, 6, endian);
      pos += 1;
      writeU(buf, pos, 1, 0, endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.magnet_status !== undefined ? d.magnet_status : 0)), endian);
      pos += 1;
    }
