// TS013 Payload Codec — milesight_at101_fh
// Schema version: 1
// Generated from: at101-fh.yaml
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      if ("[" + channel_id + ", " + channel_type + "]" === "[255, 1]") {
        ...
        var position = readU(buf, pos, 1, endian);
        pos += 1;
      ...
      } else if ("[" + channel_id + ", " + channel_type + "]" === "[8, 155]") {
        var initial_angle_x = readU(buf, pos, 1, endian);
        pos += 1;
        vars.initial_angle_x = initial_angle_x;
        d.initial_angle_x = initial_angle_x;
        var initial_angle_y = readU(buf, pos, 1, endian);
        pos += 1;
        vars.initial_angle_y = initial_angle_y;
        d.initial_angle_y = initial_angle_y;
        var initial_angle_z = readU(buf, pos, 1, endian);
        pos += 1;
        vars.initial_angle_z = initial_angle_z;
        d.initial_angle_z = initial_angle_z;
        var inclination_angle_x = readU(buf, pos, 1, endian);
        pos += 1;
        vars.inclination_angle_x = inclination_angle_x;
        d.inclination_angle_x = inclination_angle_x;
        var inclination_angle_y = readU(buf, pos, 1, endian);
        pos += 1;
        vars.inclination_angle_y = inclination_angle_y;
        d.inclination_angle_y = inclination_angle_y;
        var inclination_angle_z = readU(buf, pos, 1, endian);
        pos += 1;
        vars.inclination_angle_z = inclination_angle_z;
        d.inclination_angle_z = inclination_angle_z;
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.position !== undefined) {
      ...
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.position !== undefined ? d.position : 0)), endian);
      pos += 1;
    }
    ...
    if (d.initial_angle_x !== undefined || d.initial_angle_y !== undefined || d.initial_angle_z !== undefined || d.inclination_angle_x !== undefined || d.inclination_angle_y !== undefined || d.inclination_angle_z !== undefined) {
      writeU(buf, pos, 1, 8, endian);
      pos += 1;
      writeU(buf, pos, 1, 155, endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.initial_angle_x !== undefined ? d.initial_angle_x : 0)), endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.initial_angle_y !== undefined ? d.initial_angle_y : 0)), endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.initial_angle_z !== undefined ? d.initial_angle_z : 0)), endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.inclination_angle_x !== undefined ? d.inclination_angle_x : 0)), endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.inclination_angle_y !== undefined ? d.inclination_angle_y : 0)), endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.inclination_angle_z !== undefined ? d.inclination_angle_z : 0)), endian);
      pos += 1;
    }
