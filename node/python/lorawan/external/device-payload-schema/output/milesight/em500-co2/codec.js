// TS013 Payload Codec — milesight_em500_co2
// Schema version: 1
// Generated from: em500-co2.yaml
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      if ("[" + channel_id + ", " + channel_type + "]" === "[1, 117]") {
        ...
        var co2 = readS(buf, pos, 2, endian);
        pos += 2;
        vars.co2 = co2;
        d.co2 = co2;
      } else if ("[" + channel_id + ", " + channel_type + "]" === "[6, 115]") {
        var pressure = readS(buf, pos, 2, endian);
        pos += 2;
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.co2 !== undefined) {
      ...
      pos += 1;
      writeS(buf, pos, 2, Math.round((d.co2 !== undefined ? d.co2 : 0)), endian);
      pos += 2;
    }
    if (d.pressure !== undefined) {
      ...
      pos += 1;
      writeS(buf, pos, 2, Math.round(((d.pressure !== undefined ? d.pressure : 0) * 10)), endian);
      pos += 2;
    }
