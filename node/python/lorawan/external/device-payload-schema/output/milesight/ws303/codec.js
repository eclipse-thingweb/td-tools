// TS013 Payload Codec — milesight_ws303
// Schema version: 1
// Generated from: ws303.yaml
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      if ("[" + channel_id + ", " + channel_type + "]" === "[1, 117]") {
        ...
        var leak_status = readU(buf, pos, 1, endian);
        pos += 1;
        vars.leak_status = leak_status;
        d.leak_status = leak_status;
      } else {
        break;
      }
    }
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.leak_status !== undefined) {
      writeU(buf, pos, 1, 3, endian);
      pos += 1;
      writeU(buf, pos, 1, 0, endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.leak_status !== undefined ? d.leak_status : 0)), endian);
      pos += 1;
    }
