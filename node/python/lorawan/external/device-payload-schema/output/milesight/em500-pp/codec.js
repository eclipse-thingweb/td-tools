// TS013 Payload Codec — milesight_em500_pp
// Schema version: 1
// Generated from: em500-pp.yaml
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      if ("[" + channel_id + ", " + channel_type + "]" === "[1, 117]") {
        ...
        d.battery = battery;
      } else if ("[" + channel_id + ", " + channel_type + "]" === "[3, 123]") {
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.pressure !== undefined) {
      ...
      pos += 1;
      writeS(buf, pos, 2, Math.round((d.pressure !== undefined ? d.pressure : 0)), endian);
      pos += 2;
    }
