// TS013 Payload Codec — milesight_ws202
// Schema version: 1
// Generated from: ws202.yaml
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      if ("[" + channel_id + ", " + channel_type + "]" === "[1, 117]") {
        ...
        var light = readU(buf, pos, 1, endian);
        pos += 1;
        vars.light = light;
        d.light = light;
      } else {
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.light !== undefined) {
      ...
      writeU(buf, pos, 1, 0, endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.light !== undefined ? d.light : 0)), endian);
      pos += 1;
    }
