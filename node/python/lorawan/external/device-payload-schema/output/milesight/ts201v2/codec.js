// TS013 Payload Codec — milesight_ts201v2
// Schema version: 1
// Generated from: ts201v2.yaml
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      if ("[" + channel_id + ", " + channel_type + "]" === "[255, 1]") {
        ...
        d.humidity = humidity;
      } else if ("[" + channel_id + ", " + channel_type + "]" === "[255, 235]") {
        var temperature_unit = readU(buf, pos, 1, endian);
        pos += 1;
        vars.temperature_unit = temperature_unit;
        d.temperature_unit = temperature_unit;
      } else {
        break;
      }
    }
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.temperature_unit !== undefined) {
      writeU(buf, pos, 1, 255, endian);
      pos += 1;
      writeU(buf, pos, 1, 235, endian);
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.temperature_unit !== undefined ? d.temperature_unit : 0)), endian);
      pos += 1;
    }
