// TS013 Payload Codec — milesight_uc1152
// Schema version: 1
// Generated from: uc1152.yaml
...
function decodePayload(buf, endian) {
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      pos += 1;
      if ("[" + channel_id + ", " + channel_type + "]" === "[255, 14]") {
        var channels = readU(buf, pos, 1, endian);
        pos += 1;
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.channels !== undefined) {
      ...
      pos += 1;
      writeU(buf, pos, 1, Math.round((d.channels !== undefined ? d.channels : 0)), endian);
      pos += 1;
    }
