// TS013 Payload Codec — milesight_ts101
// Schema version: 1
// Generated from: ts101.yaml
  ...
  endian = endian || "little";
    ...
    while (pos + 2 <= buf.length) {
      ...
      if ("[" + channel_id + ", " + channel_type + "]" === "[1, 117]") {
        ...
        vars.temperature = temperature;
        d.temperature = (temperature / 10);
        var temperature_alert = readU(buf, pos, 1, endian);
        pos += 1;
        vars.temperature_alert = temperature_alert;
        d.temperature_alert = temperature_alert;
      } else if ("[" + channel_id + ", " + channel_type + "]" === "[147, 215]") {
        var temperature = readS(buf, pos, 2, endian);
        pos += 2;
        vars.temperature = temperature;
        d.temperature = (temperature / 10);
        var temperature_change = readS(buf, pos, 2, endian);
        pos += 2;
        vars.temperature_change = temperature_change;
        d.temperature_change = (temperature_change / 100);
        var temperature_alert = readU(buf, pos, 1, endian);
        pos += 1;
        vars.temperature_alert = temperature_alert;
        d.temperature_alert = temperature_alert;
...
function encodePayload(d, endian) {
  ...
  endian = endian || "little";
    ...
    if (d.temperature !== undefined || d.temperature_alert !== undefined) {
      ...
      writeS(buf, pos, 2, Math.round(((d.temperature !== undefined ? d.temperature : 0) * 10)), endian);
      pos += 2;
      writeU(buf, pos, 1, Math.round((d.temperature_alert !== undefined ? d.temperature_alert : 0)), endian);
      pos += 1;
    }
    if (d.temperature !== undefined || d.temperature_change !== undefined || d.temperature_alert !== undefined) {
      ...
      writeS(buf, pos, 2, Math.round(((d.temperature !== undefined ? d.temperature : 0) * 10)), endian);
      pos += 2;
      writeS(buf, pos, 2, Math.round(((d.temperature_change !== undefined ? d.temperature_change : 0) * 100)), endian);
      pos += 2;
      writeU(buf, pos, 1, Math.round((d.temperature_alert !== undefined ? d.temperature_alert : 0)), endian);
      pos += 1;
    }
