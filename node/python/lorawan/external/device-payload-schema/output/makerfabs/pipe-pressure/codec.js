// TS013 Payload Codec — makerfabs_pipe_pressure
// Schema version: 1
// Generated from: pipe-pressure.yaml
...
function decodePayload(buf, endian) {
  ...
  endian = endian || "big";
    ...
    var volt_pressure = readU(buf, pos, 2, endian);
    pos += 2;
    vars.volt_pressure = volt_pressure;
    d.volt_pressure = (volt_pressure / 1000);
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    pos += 1;
    writeU(buf, pos, 2, Math.round(((d.volt_pressure !== undefined ? d.volt_pressure : 0) * 1000)), endian);
    pos += 2;
