// TS013 Payload Codec — makerfabs_4ch_adc
// Schema version: 1
// Generated from: 4-channel-adc.yaml
...
function decodePayload(buf, endian) {
  ...
  endian = endian || "big";
    ...
    var adc1 = readU(buf, pos, 2, endian);
    pos += 2;
    vars.adc1 = adc1;
    d.adc1 = (adc1 / 1000);
    var adc2 = readU(buf, pos, 2, endian);
    pos += 2;
    vars.adc2 = adc2;
    d.adc2 = (adc2 / 1000);
    var adc3 = readU(buf, pos, 2, endian);
    pos += 2;
    vars.adc3 = adc3;
    d.adc3 = (adc3 / 1000);
    var adc4 = readU(buf, pos, 2, endian);
    pos += 2;
    vars.adc4 = adc4;
    d.adc4 = (adc4 / 1000);
    var differential = readU(buf, pos, 2, endian);
    pos += 2;
    vars.differential = differential;
    d.differential = (differential / 1000);
    var time_interval = readU(buf, pos, 4, endian);
    pos += 4;
    vars.time_interval = time_interval;
    d.time_interval = (time_interval / 1000);
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    pos += 1;
    writeU(buf, pos, 2, Math.round(((d.adc1 !== undefined ? d.adc1 : 0) * 1000)), endian);
    pos += 2;
    writeU(buf, pos, 2, Math.round(((d.adc2 !== undefined ? d.adc2 : 0) * 1000)), endian);
    pos += 2;
    writeU(buf, pos, 2, Math.round(((d.adc3 !== undefined ? d.adc3 : 0) * 1000)), endian);
    pos += 2;
    writeU(buf, pos, 2, Math.round(((d.adc4 !== undefined ? d.adc4 : 0) * 1000)), endian);
    pos += 2;
    writeU(buf, pos, 2, Math.round(((d.differential !== undefined ? d.differential : 0) * 1000)), endian);
    pos += 2;
    writeU(buf, pos, 4, Math.round(((d.time_interval !== undefined ? d.time_interval : 0) * 1000)), endian);
    pos += 4;
