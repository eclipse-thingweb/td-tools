// TS013 Payload Codec — decentlab_dl_atm22
// Schema version: 2
// Generated from: dl-atm22.yaml
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    // encode flagged
    var _flags = 0;
    if (d.wind_speed !== undefined || d.wind_direction !== undefined || d.maximum_wind_speed !== undefined || d.air_temperature !== undefined || d.x_orientation_angle !== undefined || d.y_orientation_angle !== undefined || d.north_wind_speed !== undefined || d.east_wind_speed !== undefined) _flags |= (1 << 0);
