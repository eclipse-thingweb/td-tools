// TS013 Payload Codec — decentlab_dl_ilt
// Schema version: 2
// Generated from: dl-ilt.yaml
...
function decodePayload(buf, endian) {
  ...
  endian = endian || "big";
    ...
    // flagged on flags
    if (vars.flags & (1 << 0)) {
      var leaf_temperature = readS(buf, pos, 2, endian);
      pos += 2;
      vars.leaf_temperature = leaf_temperature;
      d.leaf_temperature = (leaf_temperature / 100);
    }
    if (vars.flags & (1 << 1)) {
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    // encode flagged
    var _flags = 0;
    if (d.leaf_temperature !== undefined) _flags |= (1 << 0);
    if (d.battery_voltage !== undefined) _flags |= (1 << 1);
    writeU(buf, pos - 2, 2, _flags, endian);
    if (_flags & (1 << 0)) {
      writeS(buf, pos, 2, Math.round(((d.leaf_temperature !== undefined ? d.leaf_temperature : 0) * 100)), endian);
      pos += 2;
    }
    if (_flags & (1 << 1)) {
