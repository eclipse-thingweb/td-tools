// TS013 Payload Codec — decentlab_dl_pr36_8192
// Schema version: 2
// Generated from: dl-pr36-8192.yaml
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    if (_flags & (1 << 0)) {
      ...
      pos += 2;
      writeS(buf, pos, 2, Math.round(((d.temperature !== undefined ? d.temperature : 0) * 256)), endian);
      pos += 2;
    }
    if (_flags & (1 << 1)) {
