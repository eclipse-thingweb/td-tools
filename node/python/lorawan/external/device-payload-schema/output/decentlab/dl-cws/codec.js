// TS013 Payload Codec — decentlab_dl_cws
// Schema version: 2
// Generated from: dl-cws.yaml
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    // encode flagged
    var _flags = 0;
    if (d.surface_temperature !== undefined || d.air_temperature !== undefined || d.air_humidity !== undefined || d.dew_point !== undefined || d.angle !== undefined || d.sensor_temperature !== undefined) _flags |= (1 << 0);
