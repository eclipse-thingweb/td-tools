// TS013 Payload Codec — decentlab_dl_ifd
// Schema version: 2
// Generated from: dl-ifd.yaml
...
function decodePayload(buf, endian) {
  ...
  endian = endian || "big";
    ...
    // flagged on flags
    if (vars.flags & (1 << 0)) {
      var fruit_size = readU(buf, pos, 2, endian);
      pos += 2;
      vars.fruit_size = fruit_size;
      d.fruit_size = (fruit_size / 100);
    }
    if (vars.flags & (1 << 1)) {
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    // encode flagged
    var _flags = 0;
    if (d.fruit_size !== undefined) _flags |= (1 << 0);
    if (d.battery_voltage !== undefined) _flags |= (1 << 1);
    writeU(buf, pos - 2, 2, _flags, endian);
    if (_flags & (1 << 0)) {
      writeU(buf, pos, 2, Math.round(((d.fruit_size !== undefined ? d.fruit_size : 0) * 100)), endian);
      pos += 2;
    }
    if (_flags & (1 << 1)) {
