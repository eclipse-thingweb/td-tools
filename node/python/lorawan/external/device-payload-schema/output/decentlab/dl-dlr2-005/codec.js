// TS013 Payload Codec — decentlab_dl_dlr2_005
// Schema version: 2
// Generated from: dl-dlr2-005.yaml
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    // encode flagged
    var _flags = 0;
    if (d.voltage !== undefined) _flags |= (1 << 0);
    if (d.battery_voltage !== undefined) _flags |= (1 << 1);
    writeU(buf, pos - 2, 2, _flags, endian);
    if (_flags & (1 << 0)) {
      writeU(buf, pos, 2, Math.round((d.voltage !== undefined ? d.voltage : 0)), endian);
      pos += 2;
    }
    if (_flags & (1 << 1)) {
