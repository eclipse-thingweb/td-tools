// TS013 Payload Codec — decentlab_dl_dlr2_009_2000
// Schema version: 2
// Generated from: dl-dlr2-009-2000.yaml
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    // encode flagged
    var _flags = 0;
    if (d.thermistor_resistance !== undefined || d.temperature !== undefined) _flags |= (1 << 0);
