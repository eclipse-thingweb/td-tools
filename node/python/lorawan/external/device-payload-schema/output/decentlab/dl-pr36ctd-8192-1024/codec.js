// TS013 Payload Codec — decentlab_dl_pr36ctd_8192_1024
// Schema version: 2
// Generated from: dl-pr36ctd-8192-1024.yaml
...
function decodePayload(buf, endian) {
  ...
  endian = endian || "big";
    ...
    if (vars.flags & (1 << 0)) {
      ...
      d.pressure = pressure;
      var temperature_electronics = readS(buf, pos, 2, endian);
      pos += 2;
      vars.temperature_electronics = temperature_electronics;
      d.temperature_electronics = (temperature_electronics / 256);
      var temperature_pt1000 = readS(buf, pos, 2, endian);
      pos += 2;
      vars.temperature_pt1000 = temperature_pt1000;
      d.temperature_pt1000 = (temperature_pt1000 / 256);
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    // encode flagged
    var _flags = 0;
    if (d.pressure !== undefined || d.temperature_electronics !== undefined || d.temperature_pt1000 !== undefined || d.electrical_conductivity !== undefined) _flags |= (1 << 0);
    ...
    if (_flags & (1 << 0)) {
      ...
      pos += 2;
      writeS(buf, pos, 2, Math.round(((d.temperature_electronics !== undefined ? d.temperature_electronics : 0) * 256)), endian);
      pos += 2;
      writeS(buf, pos, 2, Math.round(((d.temperature_pt1000 !== undefined ? d.temperature_pt1000 : 0) * 256)), endian);
      pos += 2;
