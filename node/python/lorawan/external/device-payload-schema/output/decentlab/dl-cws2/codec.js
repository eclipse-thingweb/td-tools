// TS013 Payload Codec — decentlab_dl_cws2
// Schema version: 2
// Generated from: dl-cws2.yaml
...
function decodePayload(buf, endian) {
  ...
  endian = endian || "big";
    ...
    // flagged on flags
    if (vars.flags & (1 << 0)) {
      var air_temperature_radiation_shield = readU(buf, pos, 2, endian);
      pos += 2;
      vars.air_temperature_radiation_shield = air_temperature_radiation_shield;
      d.air_temperature_radiation_shield = air_temperature_radiation_shield;
      var air_humidity_radiation_shield = readU(buf, pos, 2, endian);
      pos += 2;
      vars.air_humidity_radiation_shield = air_humidity_radiation_shield;
      d.air_humidity_radiation_shield = air_humidity_radiation_shield;
    }
    if (vars.flags & (1 << 1)) {
      var surface_temperature = readS(buf, pos, 2, endian);
      pos += 2;
      vars.surface_temperature = surface_temperature;
      d.surface_temperature = (surface_temperature / 100);
      ...
      d.air_humidity = (air_humidity / 100);
      var dew_point = readS(buf, pos, 2, endian);
      pos += 2;
      vars.dew_point = dew_point;
      d.dew_point = (dew_point / 100);
      var angle = readU(buf, pos, 2, endian);
      pos += 2;
      vars.angle = angle;
      d.angle = angle;
      var sensor_temperature = readS(buf, pos, 2, endian);
      pos += 2;
      vars.sensor_temperature = sensor_temperature;
      d.sensor_temperature = (sensor_temperature / 100);
    }
    if (vars.flags & (1 << 2)) {
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    // encode flagged
    var _flags = 0;
    if (d.air_temperature_radiation_shield !== undefined || d.air_humidity_radiation_shield !== undefined) _flags |= (1 << 0);
    if (d.surface_temperature !== undefined || d.air_temperature !== undefined || d.air_humidity !== undefined || d.dew_point !== undefined || d.angle !== undefined || d.sensor_temperature !== undefined) _flags |= (1 << 1);
    if (d.battery_voltage !== undefined) _flags |= (1 << 2);
    writeU(buf, pos - 2, 2, _flags, endian);
    if (_flags & (1 << 0)) {
      writeU(buf, pos, 2, Math.round((d.air_temperature_radiation_shield !== undefined ? d.air_temperature_radiation_shield : 0)), endian);
      pos += 2;
      writeU(buf, pos, 2, Math.round((d.air_humidity_radiation_shield !== undefined ? d.air_humidity_radiation_shield : 0)), endian);
      pos += 2;
    }
    if (_flags & (1 << 1)) {
      writeS(buf, pos, 2, Math.round(((d.surface_temperature !== undefined ? d.surface_temperature : 0) * 100)), endian);
      pos += 2;
      writeS(buf, pos, 2, Math.round(((d.air_temperature !== undefined ? d.air_temperature : 0) * 100)), endian);
      pos += 2;
      writeS(buf, pos, 2, Math.round(((d.air_humidity !== undefined ? d.air_humidity : 0) * 100)), endian);
      pos += 2;
      writeS(buf, pos, 2, Math.round(((d.dew_point !== undefined ? d.dew_point : 0) * 100)), endian);
      pos += 2;
      writeU(buf, pos, 2, Math.round((d.angle !== undefined ? d.angle : 0)), endian);
      pos += 2;
      writeS(buf, pos, 2, Math.round(((d.sensor_temperature !== undefined ? d.sensor_temperature : 0) * 100)), endian);
      pos += 2;
    }
    if (_flags & (1 << 2)) {
