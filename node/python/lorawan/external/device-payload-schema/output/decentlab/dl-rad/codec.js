// TS013 Payload Codec — decentlab_dl_rad
// Schema version: 2
// Generated from: dl-rad.yaml
...
function decodePayload(buf, endian) {
  ...
  endian = endian || "big";
    ...
    if (vars.flags & (1 << 0)) {
      ...
      var reliability = readS(buf, pos, 2, endian);
      pos += 2;
      vars.reliability = reliability;
      d.reliability = (reliability / 100);
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    // encode flagged
    var _flags = 0;
    if (d.distance !== undefined || d.temperature !== undefined || d.reliability !== undefined || d.status !== undefined) _flags |= (1 << 0);
    ...
    if (_flags & (1 << 0)) {
      ...
      pos += 2;
      writeS(buf, pos, 2, Math.round(((d.reliability !== undefined ? d.reliability : 0) * 100)), endian);
      pos += 2;
