// TS013 Payload Codec — decentlab_dl_ds18
// Schema version: 2
// Generated from: dl-ds18.yaml
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    if (_flags & (1 << 0)) {
      writeS(buf, pos, 2, Math.round(((d.temperature !== undefined ? d.temperature : 0) * 16)), endian);
      pos += 2;
    }
    if (_flags & (1 << 1)) {
