// TS013 Payload Codec — decentlab_dl_trs11
// Schema version: 2
// Generated from: dl-trs11.yaml
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    // encode flagged
    var _flags = 0;
    if (d.dielectric_permittivity !== undefined || d.volumetric_water_content !== undefined || d.soil_temperature !== undefined) _flags |= (1 << 0);
