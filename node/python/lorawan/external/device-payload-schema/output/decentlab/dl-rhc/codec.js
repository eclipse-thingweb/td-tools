// TS013 Payload Codec — decentlab_dl_rhc
// Schema version: 2
// Generated from: dl-rhc.yaml
...
function decodePayload(buf, endian) {
  ...
  endian = endian || "big";
    ...
    // flagged on flags
    if (vars.flags & (1 << 0)) {
      var sensor_id = readU(buf, pos, 4, endian);
      pos += 4;
...
function encodePayload(d, endian) {
  ...
  endian = endian || "big";
    ...
    // encode flagged
    var _flags = 0;
    if (d.sensor_id !== undefined || d.air_humidity !== undefined || d.air_temperature !== undefined) _flags |= (1 << 0);
    if (d.battery_voltage !== undefined) _flags |= (1 << 1);
    writeU(buf, pos - 2, 2, _flags, endian);
    if (_flags & (1 << 0)) {
      writeU(buf, pos, 4, Math.round((d.sensor_id !== undefined ? d.sensor_id : 0)), endian);
      pos += 4;
      writeU(buf, pos, 2, Math.round(((d.air_humidity !== undefined ? d.air_humidity : 0) * 100)), endian);
      pos += 2;
